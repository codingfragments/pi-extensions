...
- doc: https://docs.google.com/document/d/1qk9hXpZ-XUTVSSfoJgFfXxa7i3qxBvlhQN7WQUewb50/edit
...
- doc: https://docs.google.com/document/d/1QZmWABCtjNzR6HKeT3fFP-uIRspXXaoAPnbTOj93LiM/edit

## U4: uc?export=view&id= images embed in Docs — PARTIAL

- NO permission variant worked under drive.file:
- variant {anyone, reader}: Error: POST https://www.googleapis.com/drive/v3/files/1JBh907vuZem8PEVwNCeamvjO5neAiydW/permissions -> 400: {
  "error": {
    "code": 400,
    "message": "Bad 
- variant {anyone, reader, allowFileDiscovery:false}: Error: POST https://www.googleapis.com/drive/v3/files/1JBh907vuZem8PEVwNCeamvjO5neAiydW/permissions -> 400: {
  "error": {
    "code": 400,
    "message": "Bad 
- variant {anyone, reader} + supportsAllDrives=true: Error: POST https://www.googleapis.com/drive/v3/files/1JBh907vuZem8PEVwNCeamvjO5neAiydW/permissions?supportsAllDrives=true -> 400: {
  "error": {
    "code": 40
...
- image file: https://drive.google.com/file/d/1JBh907vuZem8PEVwNCeamvjO5neAiydW/view
- doc for manual check: https://docs.google.com/document/d/1nmGjdj3f36a0etEL4GzI7_b_gA31188QHXJUP27xz4Q/edit
...
- clean sheet: https://docs.google.com/spreadsheets/d/1vMAd_B_GVU4DhgwqdK3VaDD626J0ZVsvpdGtZxeooh8/edit
- messy sheet: https://docs.google.com/spreadsheets/d/17HZHwNm6beJvwVsUXUMZgIArUGTkBrJB6nyWb06DLow/edit
- xlsx sheet: https://docs.google.com/spreadsheets/d/1HQRLima1Xw41vCya57F0vXCPIaywZechJlU1AA2BSTQ/edit

## U1: drive.file folders nest + access survives move/rename — PASS

- created root folder + 2 nested levels under My Drive root (ids …ls4ScW, …Fg0A6y, …_Wni8v)
- after parent move + rename, get and files.update inside the tree still work

Evidence:

- root: https://drive.google.com/drive/folders/1wkmx47vLwlsVn8G6xtXNQxIKe3ls4ScW
- root folder after move+rename: https://drive.google.com/drive/folders/1wkmx47vLwlsVn8G6xtXNQxIKe3ls4ScW
...
See the [target doc](https://docs.google.com/document/d/1qk9hXpZ-XUTVSSfoJgFfXxa7i3qxBvlhQN7WQUewb50/edit) for the linked object. An external link to [Google](https://www.google.com) should also survive.
